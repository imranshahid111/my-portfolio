...
export default function About() {
  ...
  return (
    <div className='bg-[#181824] mt-12 px-3 md:px-0'>
        ...
        <p className='md:text-[18px] text-[9px] font-poppins text-white pr-3'>Hi, my name is Imran Shahid. I am a MERN-Stack Developer with a strong foundation in web development and advanced UI design principles. I specialize in creating responsive, visually appealing user interfaces and seamless user experiences. With expertise in React , Mongo DB , SQL , Node , CSS, and JavaScript.</p>
