...
export default function Footor() {
  return (
    ...
    <nav class="flex justify-center flex-wrap gap-6 text-gray-400 font-medium">
        ...
        <a class="hover:text-[#7562E0]" href="#">About</a>
        <a class="hover:text-[#7562E0]" href="#">Projects</a>
        <a class="hover:text-[#7562E0]" href="#">Work</a>
        <a class="hover:text-[#7562E0]" href="#">Contact</a>
    </nav>
